...
public class Flaw : MonoBehaviour, IEnergyLockable, IRootLink
{
    ...
    private void Update() => HandleFeedback();
    ...
    private void HandleFeedback()
    {
        ...
        if (finalTargetState == _isCurrentlyTargeted) return;
    ...
    private void AnimateFeedback(bool show)
    {
        ...
        feedbackCanvasGroup.transform.DOScale(1f, 0.3f)
