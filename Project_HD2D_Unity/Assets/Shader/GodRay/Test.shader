Shader "Custom/VolumetricFog"
{
    Properties
    {
        ...
        _FogSpeed("Fog Speed", Vector) = (0.1, 0.05, 0.1, 0) // Vitesse sur X, Y, Z
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float3 scrollingOffset = _FogSpeed.xyz * _Time.y;
                float3 samplePos = (worldPos * 0.01 * _NoiseTiling) + scrollingOffset;

                float4 noise = _FogNoise.SampleLevel(sampler_TrilinearRepeat, samplePos, 0);
